...
module.exports = {
  name: "sancion5",
  author: "Ned",
  description: "Sirve para informar la sanción de un usuario, su razón y con la duración de 5 dias",
  ...
  run: async (client, message, args) => {
    ...
    .setTitle('**Informe de Sanción**')
      ...
      .addField(`Duración: `, '5 Días')
      .setColor("RED");

    message.channel.send({ embeds: [embed] });
    message.delete();

    member.user.send(`Has recibido una sancion, motivo: ${mensaje}, Duración: 5 Días`)
  },
};
