...
module.exports = {
  name: "sancion2",
  author: "Ned",
  description: "Sirve para informar la sanción de un usuario, su razón y con la duración de 2 dias",
  ...
  run: async (client, message, args) => {
    ...
    .setTitle('**Informe de Sanción**')
      ...
      .addField(`Duración: `, '2 Días')
      .setColor("RED");

    message.channel.send({ embeds: [embed] });
    message.delete();

    member.user.send(`Has recibido una sancion, motivo: ${mensaje}, Duración: 2 Días`)
  },
};
