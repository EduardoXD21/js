...
module.exports = {
  name: "sancion6",
  author: "Ned",
  description: "Sirve para informar la sanción de un usuario, su razón y con la duración de 6 dias",
  ...
  run: async (client, message, args) => {
    ...
    .setTitle('**Informe de Sanción**')
      ...
      .addField(`Duración: `, '6 Días')
      .setColor("RED");

    message.channel.send({ embeds: [embed] });
    message.delete();

    member.user.send(`Has recibido una sancion, motivo: ${mensaje}, Duración: 6 Días`)
  },
};
