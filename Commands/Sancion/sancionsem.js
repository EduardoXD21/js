...
module.exports = {
  name: "sancion1s",
  author: "Ned",
  description: "Sirve para informar la sanción de un usuario, su razón y con la duración de 1 semana",
  ...
  run: async (client, message, args) => {
    ...
    .setTitle('**Informe de Sanción**')
      ...
      .addField(`Duración: `, '1 Semana')
      .setColor("RED");

    message.channel.send({ embeds: [embed] });
    message.delete();

    member.user.send(`Has recibido una sancion, motivo: ${mensaje}, Duración: 1 Semana`)
  },
};
