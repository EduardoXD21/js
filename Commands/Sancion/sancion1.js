...
module.exports = {
  name: "sancion1",
  author: "Ned",
  description: "Sirve para informar la sanción de un usuario, su razón y con la duración de 1 dia",
  ...
  run: async (client, message, args) => {
    ...
    .setTitle('**Informe de Sanción**')
      ...
      .addField(`Duración: `, '1 Día')
      .setColor("RED");

    message.channel.send({ embeds: [embed] });
    message.delete();

    member.user.send(`Has recibido una sancion, motivo: ${mensaje}, Duración: 1 Día`)
  },
};
